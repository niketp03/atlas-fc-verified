...
/-
Provenance: verbatim copy of `Atlas/FC/Erdos337_ruzsa_turjanyi_solution.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `Erdos337` renamed to `Atlas.Erdos337`, because the Atlas file reuses the
...
Target: `erdos_337.variants.ruzsa_turjanyi` in `FormalConjectures.ErdosProblems.«337»`.
-/
