...
/-
Provenance: verbatim copy of `Atlas/FC/Erdos138_dvd_two_pow_solution.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `Erdos138` renamed to `Atlas.Erdos138`, because the Atlas file reuses the
...
Target: `erdos_138.variants.dvd_two_pow` in `FormalConjectures.ErdosProblems.«138»`.
-/
