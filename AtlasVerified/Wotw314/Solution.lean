...
/-
Provenance: verbatim copy of `Atlas/FC/WrittenOnTheWallII_GraphConjecture314_conjecture314.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `WrittenOnTheWallII.GraphConjecture314` renamed to `Atlas.WrittenOnTheWallII.GraphConjecture314`, because the Atlas file reuses the
...
Target: `conjecture314` in `FormalConjectures.WrittenOnTheWallII.GraphConjecture314`.
-/
...
namespace Atlas.WrittenOnTheWallII.GraphConjecture314
...
theorem conjecture314 [Nontrivial α] (G : SimpleGraph α) [DecidableRel G.Adj]
  ...
  · exact no_minimal_total_dominating_sets_of_card_two_and_three G hTriFree hPath
      T S hT hS hT2 hS3
end Atlas.WrittenOnTheWallII.GraphConjecture314