...
/-
Provenance: verbatim copy of `Atlas/FC/Green25_upper_solution.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `Green25` renamed to `Atlas.Green25`, because the Atlas file reuses the
...
Target: `green_25.upper` in `FormalConjectures.GreensOpenProblems.«25»`.
-/
