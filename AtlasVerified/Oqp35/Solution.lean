...
/-
Provenance: verbatim copy of `Atlas/FC/OpenQuantumProblem35_ame_9_10_open_solution.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `OpenQuantumProblem35` renamed to `Atlas.OpenQuantumProblem35`, because the Atlas file reuses the
...
Target: `ame_9_10_open` in `FormalConjectures.OpenQuantumProblems.«35»`.
-/
...
namespace Atlas.OpenQuantumProblem35
...
end Atlas.OpenQuantumProblem35