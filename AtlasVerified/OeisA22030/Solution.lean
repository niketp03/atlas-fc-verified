...
/-
Provenance: verbatim copy of `Atlas/FC/OeisA22030_conjecture.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `OeisA22030` renamed to `Atlas.OeisA22030`, because the Atlas file reuses the
...
Target: `conjecture` in `FormalConjectures.OEIS.«22030»`.
-/
