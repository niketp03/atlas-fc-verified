...
/-
Provenance: verbatim copy of `Atlas/FC/OeisA108081_count_words_in_x_is_a_shifted.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `OeisA108081` renamed to `Atlas.OeisA108081`, because the Atlas file reuses the
...
Target: `count_words_in_x_is_a_shifted` in `FormalConjectures.OEIS.«108081»`.
-/
