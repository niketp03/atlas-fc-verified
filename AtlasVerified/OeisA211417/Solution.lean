...
/-
Provenance: verbatim copy of `Atlas/FC/OeisA211417_supercongruence_solution.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `OeisA211417` renamed to `Atlas.OeisA211417`, because the Atlas file reuses the
...
Target: `supercongruence` in `FormalConjectures.OEIS.«211417»`.
-/
