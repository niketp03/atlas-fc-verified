...
/-
Provenance: verbatim copy of `Atlas/FC/WrittenOnTheWallII_GraphConjecture100_conjecture100.lean` from
facebookresearch/atlas-lean @ prepare-atlas-v2 (223d8bc), with two mechanical
changes only:
  * namespace `WrittenOnTheWallII.GraphConjecture100` renamed to `Atlas.WrittenOnTheWallII.GraphConjecture100`, because the Atlas file reuses the
...
Target: `conjecture100` in `FormalConjectures.WrittenOnTheWallII.GraphConjecture100`.
-/
...
namespace Atlas.WrittenOnTheWallII.GraphConjecture100
open SimpleGraph
...
theorem conjecture100 (G : SimpleGraph α) [DecidableRel G.Adj] (h : G.Connected) :
  ...
  exact_mod_cast hz
end Atlas.WrittenOnTheWallII.GraphConjecture100