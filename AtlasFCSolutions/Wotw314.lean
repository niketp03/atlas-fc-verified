...
**Problem:** `WrittenOnTheWallII.GraphConjecture314.conjecture314` in
[`FormalConjectures/WrittenOnTheWallII/GraphConjecture314.lean`](https://github.com/google-deepmind/formal-conjectures/blob/990d209a1ffbe75e59e11267242675931f524824/FormalConjectures/WrittenOnTheWallII/GraphConjecture314.lean).

**Solution:** `AtlasFCSolutions.Wotw314.conjecture314` at the bottom of this file.

The problem file is imported, and every definition the statement mentions is formal-conjectures'
own (reached through `open WrittenOnTheWallII.GraphConjecture314`); this file declares no copy of any of them. The final
theorem has the same name as the formal-conjectures theorem and repeats its statement.

The proof is from `Atlas/FC/WrittenOnTheWallII_GraphConjecture314_conjecture314.lean` in
...
-- formal-conjectures' namespace and not to `AtlasFCSolutions.WrittenOnTheWallII.GraphConjecture314`.
open WrittenOnTheWallII.GraphConjecture314

namespace AtlasFCSolutions.Wotw314
...
end AtlasFCSolutions.Wotw314

#print axioms AtlasFCSolutions.Wotw314.conjecture314
