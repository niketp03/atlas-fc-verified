...
**Problem:** `OeisA22030.conjecture` in
[`FormalConjectures/OEIS/22030.lean`](https://github.com/google-deepmind/formal-conjectures/blob/990d209a1ffbe75e59e11267242675931f524824/FormalConjectures/OEIS/22030.lean).

**Solution:** `AtlasFCSolutions.OeisA22030.conjecture` at the bottom of this file.

The problem file is imported, and every definition the statement mentions is formal-conjectures'
own (reached through `open OeisA22030`); this file declares no copy of any of them. The final
theorem has the same name as the formal-conjectures theorem and repeats its statement.

The proof is from `Atlas/FC/OeisA22030_conjecture.lean` in
...
-- formal-conjectures' namespace and not to `AtlasFCSolutions.OeisA22030`.
open OeisA22030

namespace AtlasFCSolutions.OeisA22030
...
end AtlasFCSolutions.OeisA22030

#print axioms AtlasFCSolutions.OeisA22030.conjecture
