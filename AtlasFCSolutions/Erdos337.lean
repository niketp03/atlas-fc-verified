...
/-!
# Erdős Problem 337 — the Ruzsa–Turjányi conjecture

**Problem:** `Erdos337.erdos_337.variants.ruzsa_turjanyi` in
[`FormalConjectures/ErdosProblems/337.lean`](https://github.com/google-deepmind/formal-conjectures/blob/990d209a1ffbe75e59e11267242675931f524824/FormalConjectures/ErdosProblems/337.lean).

**Solution:** `AtlasFCSolutions.Erdos337.erdos_337.variants.ruzsa_turjanyi` at the bottom of this file.

The problem file is imported, and every definition the statement mentions is formal-conjectures'
own (reached through `open Erdos337`); this file declares no copy of any of them. The final
theorem has the same name as the formal-conjectures theorem and repeats its statement.

The proof is from `Atlas/FC/Erdos337_ruzsa_turjanyi_solution.lean` in
...
-- formal-conjectures' namespace and not to `AtlasFCSolutions.Erdos337`.
open Erdos337

namespace AtlasFCSolutions.Erdos337
...
end AtlasFCSolutions.Erdos337

#print axioms AtlasFCSolutions.Erdos337.erdos_337.variants.ruzsa_turjanyi
