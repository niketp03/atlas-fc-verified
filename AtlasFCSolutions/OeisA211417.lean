...
/-!
# OEIS A211417 — the supercongruence `a(p^k) ≡ a(p^(k-1)) mod p^(3k)`

**Problem:** `OeisA211417.supercongruence` in
[`FormalConjectures/OEIS/211417.lean`](https://github.com/google-deepmind/formal-conjectures/blob/990d209a1ffbe75e59e11267242675931f524824/FormalConjectures/OEIS/211417.lean).

**Solution:** `AtlasFCSolutions.OeisA211417.supercongruence` at the bottom of this file.

The problem file is imported, and every definition the statement mentions is formal-conjectures'
own (reached through `open OeisA211417`); this file declares no copy of any of them. The final
theorem has the same name as the formal-conjectures theorem and repeats its statement.

The proof is from `Atlas/FC/OeisA211417_supercongruence_solution.lean` in
...
-- formal-conjectures' namespace and not to `AtlasFCSolutions.OeisA211417`.
open OeisA211417

namespace AtlasFCSolutions.OeisA211417
...
end AtlasFCSolutions.OeisA211417

#print axioms AtlasFCSolutions.OeisA211417.supercongruence
