...
**Problem:** `WrittenOnTheWallII.GraphConjecture100.conjecture100` in
[`FormalConjectures/WrittenOnTheWallII/GraphConjecture100.lean`](https://github.com/google-deepmind/formal-conjectures/blob/990d209a1ffbe75e59e11267242675931f524824/FormalConjectures/WrittenOnTheWallII/GraphConjecture100.lean).

**Solution:** `AtlasFCSolutions.Wotw100.conjecture100` at the bottom of this file.

The problem file is imported, and every definition the statement mentions is formal-conjectures'
own (reached through `open WrittenOnTheWallII.GraphConjecture100`); this file declares no copy of any of them. The final
theorem has the same name as the formal-conjectures theorem and repeats its statement.

The proof is from `Atlas/FC/WrittenOnTheWallII_GraphConjecture100_conjecture100.lean` in
...
-- formal-conjectures' namespace and not to `AtlasFCSolutions.WrittenOnTheWallII.GraphConjecture100`.
open WrittenOnTheWallII.GraphConjecture100

namespace AtlasFCSolutions.Wotw100
...
end AtlasFCSolutions.Wotw100

#print axioms AtlasFCSolutions.Wotw100.conjecture100
